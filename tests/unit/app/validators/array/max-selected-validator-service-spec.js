describe('MaxSelectedValidatorService', function() {
  ...
  it('should return TRUE when the answer.data.array contains less checked elements than is allowed on reference', function() {
    var answer = {
      'data': [Mock.checkboxAnswerTrue, Mock.checkboxAnswerTrue, Mock.checkboxAnswerFalse, Mock.checkboxAnswerFalse]
    };
    var data = {
      'reference': 3
    };
  ...
  it('should return TRUE when the answer.data.array contains the same number of checked elements on reference', function() {
    var answer = {
      'data': [Mock.checkboxAnswerTrue, Mock.checkboxAnswerTrue]
    };
    var data = {
      'reference': 2
    };
